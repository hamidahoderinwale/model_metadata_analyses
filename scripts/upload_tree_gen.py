...
# Import from script3
try:
    from model_metadata_analyses.base_tree_gen import dfs_finetunes, save_json, save_csv
    print("Successfully imported functions from base_tree_gen.py")
except ImportError as e:
    raise ImportError(f"Failed to import functions from base_tree_gen.py: {e}. Make sure base_tree_gen.py exists and contains the required functions.")
